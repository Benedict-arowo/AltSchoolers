    ...
    <div className="lg:px-12 md:px-6 px-1 mb-6">
      <main className="flex-1 max-w-screen-lg w-full mx-auto py-6">
        ...
        <div className="mt-14 w-full">
          <h2 className="font-bold text-3xl w-full text-center">Sign up</h2>
          <p className="font-medium text-sm mt-2 w-full text-center">
            Please enter your details to create an account
          </p>
        </div>

        <form className="px-4 md:px-16 " onSubmit={handleSubmit(onSubmit)}>
                ...
                <fieldset className="grid w-full items-center gap-1.5">
                  ...
                  <div className="flex flex-row items-center gap-2 border-2 border-secondary px-2 rounded-md py-0.5 focus-within:border-primary">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateFormData('phoneNumber', e.currentTarget.value)
                      }
                      className="font-normal px-1 border-none outline-none py-2 w-full pl-4 pr-6 shadow-none"
                ...
                <fieldset className="grid w-full items-center gap-1.5">
                  ...
                  <div className="flex flex-row items-center gap-2 border-2 border-secondary px-2 rounded-md py-0.5 focus-within:border-primary">
                    ...
                    <Calendar
                      value={formData.dob}
                      {...register('dob')}
                      onChange={(e) => updateFormData('dob', e.value)}
                      dateFormat="dd/mm/yy"
                ...
                <fieldset className="grid w-full items-center gap-1.5">
                  ...
                  <div className="flex flex-row gap-2">
                    ...
                    >
                      ...
                      <p className="font-light text-accent">Male</p>
                    </div>
                    <div
                    ...
                    >
                      ...
                      <p className="font-light text-accent">Female</p>
                    </div>
                  </div>
                </fieldset>
              </section>
                ...
                <fieldset className="grid w-full items-center gap-1.5">
                  ...
                  <div className="flex flex-row items-center gap-2 border-2 border-secondary px-2 rounded-md py-0.5 focus-within:border-primary">
                    ...
                    <Dropdown
                      ...
                      onChange={(e) => updateFormData('stateOfOrigin', e.value)}
                ...
                <fieldset className="grid w-full items-center gap-1.5">
                  ...
                  <div className="flex flex-row items-center gap-2 border-2 border-secondary px-2 rounded-md py-0.5 focus-within:border-primary">
                    ...
                    <InputText
                      ...
                      onChange={(e) =>
                        updateFormData('address', e.currentTarget.value)
                      }
          ...
          <section className="mt-16 w-full">
            ...
            <p className="w-full text-center text-accent">
              Fill each field with <span className="text-black">None</span> if
                ...
                <fieldset className="grid w-full items-center gap-1.5">
                  ...
                  <div className="flex flex-row items-center gap-2 border-2 border-secondary px-2 rounded-md py-0.5 focus-within:border-primary">
                    ...
                    <InputText
                      ...
                      onChange={(e) =>
                        updateFormData('pastProcedures', e.currentTarget.value)
                      }
                ...
                <fieldset className="grid w-full items-center gap-1.5">
                  ...
                  <div className="flex flex-row items-center gap-2 border-2 border-secondary px-2 rounded-md py-0.5 focus-within:border-primary">
                    ...
                    <InputText
                      ...
                      onChange={(e) =>
                        updateFormData('allergies', e.currentTarget.value)
                      }
                ...
                <fieldset className="grid w-full items-center gap-1.5">
                  ...
                  <div className="flex flex-row items-center gap-2 border-2 border-secondary px-2 rounded-md py-0.5 focus-within:border-primary">
                    ...
                    <InputText
                      ...
                      {...register('bloodType')}
                      onChange={(e) =>
                        updateFormData('bloodType', e.currentTarget.value)
                      }
                ...
                <fieldset className="grid w-full items-center gap-1.5">
                  ...
                  <div className="flex flex-row items-center gap-2 border-2 border-secondary px-2 rounded-md py-0.5 focus-within:border-primary">
                    ...
                    <InputTextarea
                      ...
                      onChange={(e) =>
                        updateFormData('familyHistory', e.currentTarget.value)
                      }
          ...
          <section className="mt-16 w-full flex flex-col gap-1 ">
            ...
            <div className="flex flex-row items-center gap-4">
              <TriStateCheckbox value={true} />
              <p className="text-accent">
                I consent to sharing my health information with my healthcare
                providers within the HealthSync network
              </p>
            </div>
            <div className="flex flex-row items-center gap-4">
              <TriStateCheckbox value={true} />
